...
echo "RESOLUTION, ${RESOLUTION_ARRAY[@]}"
echo "STEP_SIZE, ${STEP_SIZE_ARRAY[@]}"
echo "TRANSFORMATION_EPSILON,${TRANSFORMATION_EPSILON_ARRAY[@]}"
echo "MAXIMUM_ITERATIONS,${MAXIMUM_ITERATIONS_ARRAY[@]}"
echo "LEAF_SIZE,${LEAF_SIZE_ARRAY[@]}"
echo "MINIMUM_SCAN_RANGE,${MINIMUM_SCAN_RANGE_ARRAY[@]}"
echo "MAXIMUM_SCAN_RANGE,${MAXIMUM_SCAN_RANGE_ARRAY[@]}"
echo "MINIMUM_ADD_SCAN_SHIFT,${MINIMUM_ADD_SCAN_SHIFT_ARRAY[@]}"

echo "RESOLUTION,${RESOLUTION_ARRAY[@]}" > ../output/param_list.csv
echo "STEP_SIZE,${STEP_SIZE_ARRAY[@]}" >> ../output/param_list.csv
echo "TRANSFORMATION_EPSILON,${TRANSFORMATION_EPSILON_ARRAY[@]}" >> ../output/param_list.csv
echo "MAXIMUM_ITERATIONS,${MAXIMUM_ITERATIONS_ARRAY[@]}" >> ../output/param_list.csv
echo "LEAF_SIZE,${LEAF_SIZE_ARRAY[@]}" >> ../output/param_list.csv
echo "MINIMUM_SCAN_RANGE,${MINIMUM_SCAN_RANGE_ARRAY[@]}" >> ../output/param_list.csv
echo "MAXIMUM_SCAN_RANGE,${MAXIMUM_SCAN_RANGE_ARRAY[@]}" >> ../output/param_list.csv
echo "MINIMUM_ADD_SCAN_SHIFT,${MINIMUM_ADD_SCAN_SHIFT_ARRAY[@]}" >> ../output/param_list.csv
