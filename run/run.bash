          ...
          do 
            ...
            do 
              ...
              do
                ...
                if [ $NODE_NUM -le $LAST_NODE_NUM ] ;then
                  echo $NODE_NUM
                ...
                if [ $NODE_NUM -eq $(($LAST_NODE_NUM+1)) ] ;then
                  NODE_NUM=$FIRST_NODE_NUM
                  #new terminal
                  ...
                  do
                    ...
                    do
                      xterm -e bash -c "cd ~/slam_kitti_ws/methods/Autoware/ros; source devel/setup.bash; roslaunch lidar_localizer ndt_mapping${i}.launch" &
                      sleep 1
                    done  
                    sleep 10
                    ...
                    if [ $SEQUENCE -lt 10 ] ;then
                      xterm -e bash -c "cd ~/slam_kitti_ws/mypkg/catkin_ws/; source devel/setup.bash; rosrun kitti_player kitti_player -d /media/ohashi/e5c3c17e-1d77-4109-ae86-cb7c80ff9c1c/share/rosbag/Kitti/odometry/dataset/sequences/0${SEQUENCE} --velodyne 1 --grayscale 1 --color 1 --groundtruth 1 --timestamps 1 --frequency 500 /sensor/camera/grayscale/left/image_rect:=/sensor/camera/grayscale/left/image_raw /sensor/camera/grayscale/right/image_rect:=/sensor/camera/grayscale/right/image_raw" &
sleep 1
                    else
                      xterm -e bash -c "cd ~/slam_kitti_ws/mypkg/catkin_ws/; source devel/setup.bash; rosrun kitti_player kitti_player -d /media/ohashi/e5c3c17e-1d77-4109-ae86-cb7c80ff9c1c/share/rosbag/Kitti/odometry/dataset/sequences/$SEQUENCE --velodyne 1 --grayscale 1 --color 1 --groundtruth 1 --timestamps 1 --frequency 5 /sensor/camera/grayscale/left/image_rect:=/sensor/camera/grayscale/left/image_raw /sensor/camera/grayscale/right/image_rect:=/sensor/camera/grayscale/right/image_raw" &
sleep 1
                    fi
                    ...
                    do
                      ...
                      do
                        ...
                        echo "Finish error calculation: $tmp"
                        if [ $tmp -eq 1 ] ;then
